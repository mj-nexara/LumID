export function generate<S extends Record<string, any> = API.Service>({ name, agent }: {
    name: string;
...
export function createAuthorization<S extends Record<string, any> = API.Service>({ signer, name }: Model<S>, { audience, access, expiration, }: {
