...
import { ServiceMethod, ConnectionView, Signer, Proof, DID, Principal, Failure, Delegation, Await, Connection } from '@ucanto/interface';
import { UCANConclude, UCANConcludeSuccess, UCANConcludeFailure, BlobModel, SpaceBlobAdd, SpaceBlobAddSuccess, SpaceBlobAddFailure, BlobAllocate, BlobAllocateSuccess, BlobAllocateFailure, BlobAccept, BlobAcceptSuccess, BlobAcceptFailure, SpaceBlobRemove, SpaceBlobRemoveSuccess, SpaceBlobRemoveFailure, SpaceBlobList, SpaceBlobListSuccess, SpaceBlobListFailure, SpaceBlobGet, SpaceBlobGetSuccess, SpaceBlobGetFailure, SpaceBlobReplicate, SpaceBlobReplicateSuccess, SpaceBlobReplicateFailure, SpaceIndexAdd, SpaceIndexAddSuccess, SpaceIndexAddFailure, UploadAdd, UploadAddSuccess, UploadList, UploadListSuccess, UploadListItem, UploadRemove, UploadRemoveSuccess, ListResponse, CARLink, PieceLink, UploadGet, UploadGetSuccess, UploadGetFailure, UsageReport, UsageReportSuccess, UsageReportFailure, EgressData, EgressRecord, EgressRecordSuccess, EgressRecordFailure, ServiceAbility } from '@storacha/capabilities/types';
...
import { ShardedDAGIndex, ShardDigest, SliceDigest, Position } from '@storacha/blob-index/types';
...
export type { FetchOptions, BlobModel, SpaceBlobAddSuccess, SpaceBlobAddFailure, BlobAllocate, BlobAllocateSuccess, BlobAllocateFailure, BlobAccept, BlobAcceptSuccess, BlobAcceptFailure, SpaceBlobRemove, SpaceBlobRemoveSuccess, SpaceBlobRemoveFailure, SpaceBlobList, SpaceBlobListSuccess, SpaceBlobListFailure, SpaceBlobGet, SpaceBlobGetSuccess, SpaceBlobGetFailure, SpaceIndexAdd, SpaceIndexAddSuccess, SpaceIndexAddFailure, UploadAdd, UploadAddSuccess, UploadGetSuccess, UploadGetFailure, UploadList, UploadListSuccess, UploadListItem, UploadRemove, UploadRemoveSuccess, UsageReport, UsageReportSuccess, UsageReportFailure, EgressData, EgressRecord, EgressRecordSuccess, EgressRecordFailure, ListResponse, CARLink, PieceLink, ShardedDAGIndex, ShardDigest, SliceDigest, Position, };
export type { Capability, Channel, Connection, DID, Failure, InferReceipt, Invocation, Principal, Receipt, Result, Signer, SignerArchive, UCANLink, UnknownLink, } from '@ucanto/interface';
...
export interface Service extends StorefrontService {
    ...
    space: {
        blob: {
            ...
            replicate: ServiceMethod<SpaceBlobReplicate, SpaceBlobReplicateSuccess, SpaceBlobReplicateFailure>;
        };
        index: {
...
export interface UploadFileOptions extends UploadOptions, UnixFSEncoderSettingsOptions {
}
export interface UploadDirectoryOptions extends UploadOptions, UnixFSEncoderSettingsOptions, UnixFSDirectoryEncoderOptions {
    /**
...
export interface ReceiptGetOptions<S extends Record<string, any>> extends Abortable {
    fetch?: typeof globalThis.fetch;
    endpoint?: URL;
