 ...
 */
export function uploadFile(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, file: import("./types.js").BlobLike, options?: import("./types.js").UploadFileOptions): Promise<import("./types.js").AnyLink>;
/**
 ...
 */
export function uploadDirectory(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, files: import("./types.js").FileLike[], options?: import("./types.js").UploadDirectoryOptions): Promise<import("./types.js").AnyLink>;
/**
 ...
 */
export function uploadCAR(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, car: import("./types.js").BlobLike, options?: import("./types.js").UploadOptions): Promise<import("./types.js").AnyLink>;
/**
 ...
 */
export function uploadBlockStream(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, blocks: ReadableStream<import("@ipld/unixfs").Block>, { pieceHasher, ...options }?: import("./types.js").UploadOptions): Promise<import("./types.js").AnyLink>;
/**
 * @param {import('./types.js').InvocationConfig|import('./types.js').InvocationConfigurator} conf
 ...
 * @returns {Promise<import('./types.js').AnyLink>}
 */
export function uploadBlocks(conf: import("./types.js").InvocationConfig | import("./types.js").InvocationConfigurator, blocks: import("@ipld/unixfs").Block[], { pieceHasher, ...options }?: import("./types.js").UploadOptions): Promise<import("./types.js").AnyLink>;
